 ...
 * }} input
 */
function evaluateOrphanSceneHotspot(input) {
 ...
 */
function assertAuditEnvironment(args, env = process.env) {
 ...
 * @returns {boolean}
 */
function shouldExecuteWrites(args) {
 ...
 * @returns {string}
 */
function formatMarkdownReport(findings, meta) {
  const lines = [
